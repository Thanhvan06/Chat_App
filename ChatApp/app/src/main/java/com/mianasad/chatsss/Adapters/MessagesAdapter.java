...
import com.mianasad.chatsss.databinding.DeleteDialogBinding;
import com.mianasad.chatsss.databinding.ItemReceiveBinding;
import com.mianasad.chatsss.databinding.ItemSentBinding;
...
//
        ...
        if(holder.getClass() == SentViewHolder.class) {
            ...
            if (message.getMessage().equals("audio")){
                viewHolder.binding.sentAudio.setVisibility(View.VISIBLE);
                viewHolder.binding.message.setVisibility(View.GONE);
                Glide.with(context)
                        .load(message.getAudioFile())
                        .placeholder(R.drawable.ic_voice)
                        .into(viewHolder.binding.txtUserName);
            }
            ...
            if (message.getMessage().equals("audio")){
                viewHolder.binding.receiveAudio.setVisibility(View.VISIBLE);
                viewHolder.binding.message.setVisibility(View.GONE);
                Glide.with(context)
                        .load(message.getAudioFile())
                        .placeholder(R.drawable.ic_voice)
